    ...
    return (
        <Transition.Root as={Fragment} show={open}>
            <Dialog as='div' className='fixed z-0 inset-0 overflow-y-auto' onClose={setOpen}>
                <div
                    className='flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0 font-serif'>
                    <Transition.Child
                        as={Fragment}
                    ...
                    >
                        <div
                            className="inline-block font-serif align-bottom bg-white rounded-2xl pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-6xl sm:w-full">
                            ...
                            <Dialog.Title
                                as='h3'
                                className='inline-flex items-center justify-center text-md font-semibold leading-6 text-blue-dark pl-5 pb-5 pt-4 mb-1'
                            >
                                {title}
                            </Dialog.Title>
                            ...
                            <header className='flex flex-col items-center text-lg text-center bg-snow md:block lg:block xl:block md:items-start lg:items-start
                                xl:items-start md:text-left lg:text-left xl:text-left md:relative lg:relative xl:relative'
                            >
